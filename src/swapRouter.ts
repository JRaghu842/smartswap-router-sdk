...
import { Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress, WETH9 } from 'smartswap-sdk-core'
import { abi } from 'smartswap-router-contracts/artifacts/contracts/interfaces/ISwapRouter02.sol/ISwapRouter02.json'
import { Trade as V2Trade } from 'smartswap-v2-sdk'
import {
  encodeRouteToPath,
  FeeOptions,
  MethodParameters,
